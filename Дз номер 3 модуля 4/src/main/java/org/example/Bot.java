...
public class Bot extends TelegramLongPollingBot {
    ...
    public String getBotUsername() {
        return "CucumberOnlineExtremePro";
    }
    ...
    // Метод для выполнения общих команд
    ...
    // Метод для обработки сообщения с фото
    ...
    // Метод для обработки фильтрации фото
    ...
    // Получение списка файлов из сообщения
    ...
    private static ArrayList<KeyboardRow> getKeyboardRows(Class someClass) {
        ...
        for (int rowIndex = 0; rowIndex < rowCount; rowIndex++) {
            ...
            for (int columnIndex = 0; columnIndex < columCount; columnIndex++) {
                int index = rowIndex * columCount + columnIndex;
                if (index >= commands.size()) continue;
                AppBotCommand command = commands.get(rowIndex * columCount + columnIndex);
